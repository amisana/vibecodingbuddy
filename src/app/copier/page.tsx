...
export default function CopierPage() {
  ...
  const generateMarkdown = useCallback(async () => {
    ...
    try {
      ...
      let md = `# Code Structure by Vibe Code Buddy\n\n`;
    ...
    <div className="min-h-screen p-4 sm:p-6 flex flex-col items-center noise-texture crt-overlay">
      <div className="max-w-3xl w-full flex flex-col gap-4 items-center">
        ...
        <div className="w-full max-w-3xl mb-3">
          <div className="border rounded-xl overflow-hidden shadow-sm content-overlay">
            <button 
              className={`w-full p-4 text-left font-semibold flex justify-between items-center ${rootDirectory ? 'bg-poolbeige dark:bg-pooldark/30 border-poolpink dark:border-poolpink' : 'bg-poolbeige dark:bg-pooldark/10'}`} 
              onClick={() => toggleSection('rootDirectory')}
            >
              <div className="flex items-center">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-poolbeige dark:bg-pooldark border border-poolpink text-poolteal dark:text-poolteal mr-3 text-sm">
                  1
                </span>
                <span className="pixel-heading">SELECT ROOT FOLDER</span>
              </div>
              <div className="flex items-center">
                {rootDirectory && (
              ...
              <div className="p-6 border-t">
                ...
                {!rootDirectory ? (
                  <button
                    ...
                    className="bg-poolteal hover:bg-poolteal/80 text-white py-2 px-4 rounded-md transition-colors inline-flex items-center justify-center vapor-button"
                    ...
                    <div className="flex items-center p-3 mb-4 bg-gray-50 dark:bg-gray-800 rounded-md">
                      ...
                      <div className="flex gap-2">
                        <button 
                          ...
                          disabled={isGenerating}
                          className="text-poolteal hover:text-poolteal/80 transition-colors p-2 disabled:opacity-50"
        ...
        <div className="w-full max-w-3xl mb-3">
          <div className="border rounded-xl overflow-hidden shadow-sm content-overlay">
            <button 
              className={`w-full p-4 text-left font-semibold flex justify-between items-center ${files.length > 0 ? 'bg-poolbeige dark:bg-pooldark/30 border-poolpink dark:border-poolpink' : 'bg-poolbeige dark:bg-pooldark/10'}`} 
            ...
            >
              <div className="flex items-center">
                ...
                <span className="pixel-heading">SELECT FILES TO PROCESS</span>
              </div>
              <div className="flex items-center">
                {files.length > 0 && (
                  <span className="text-xs bg-poolbeige dark:bg-pooldark/40 text-poolteal dark:text-poolteal border border-poolpink py-1 px-2 rounded-full mr-2">
                ...
                <div 
                  className={`border-2 border-dashed rounded-xl flex flex-col items-center justify-center p-6 transition-all duration-200 ${
                    !rootDirectory 
                      ...
                      : isDragging 
                        ? 'border-poolpink bg-poolbeige dark:bg-pooldark/20 scale-102 shadow-lg' 
        ...
        <div className="w-full max-w-3xl mb-3">
          <div className="border rounded-xl overflow-hidden shadow-sm content-overlay">
            <button 
              className={`w-full p-4 text-left font-semibold flex justify-between items-center ${ignorePatterns.length > 0 ? 'bg-poolbeige dark:bg-pooldark/30 border-poolpink dark:border-poolpink' : 'bg-poolbeige dark:bg-pooldark/10'}`} 
            ...
            >
              <div className="flex items-center">
                ...
                <span className="pixel-heading">SET IGNORE PATTERNS</span>
              </div>
              <div className="flex items-center">
        ...
        {rootDirectory && files.length > 0 && (
          <div className="w-full max-w-3xl mb-3">
            <div className="border rounded-xl overflow-hidden shadow-sm content-overlay">
              <button 
                className={`w-full p-4 text-left font-semibold flex justify-between items-center ${markdown ? 'bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400' : 'bg-poolbeige dark:bg-pooldark/10'}`} 
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="pixel-heading">GENERATE MARKDOWN</span>
                </div>
                <div className="flex items-center">
                  {markdown && (
                ...
                <div className="p-6 border-t">
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      disabled={isGenerating}
                      className={`px-6 py-3 bg-poolteal text-white rounded-md hover:bg-poolteal/80 transition-colors flex items-center vapor-button ${
